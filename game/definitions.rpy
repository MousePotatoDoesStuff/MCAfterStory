...
init python:
    ...
    def delete_characters(names=['monika','sayori','yuri','natsuki']):
        if type(names) != list:
    ...
    def restore_all_characters():
        return # MPDS_edit - temporary until I add characters
...
image bg club_day2: # Glitched Club BG
    ...
    choice:
        "bg/club-skill.png"
image bg club_day3 = "bg/club-skill.png" # Glitched Club BG
...
define t = DynamicCharacter('professor', what_prefix='"', what_suffix='"', ctc="ctc", ctc_position="fixed")
define co = DynamicCharacter('councilor', what_prefix='"', what_suffix='"', ctc="ctc", ctc_position="fixed")

define mc = DynamicCharacter('mc_name', what_prefix='"', what_suffix='"', ctc="ctc", ctc_position="fixed")
