...
define config.name = "MC After Story"
...
#   Linux: $HOME/.renpy/
define config.save_directory = "MCAS"+"_"+config.version.replace('.','_').split('_')[0]
...
init python:
    ...
    build.classify('**~', None) # TODO deal with build stuff later
